...
Last modified by Keith Ditchburn: 26th January 2014
...
// a type used to hold a byte (1 byte or 8 bits) of data
typedef unsigned char BYTE;

// a type used to hold a WORD (2 bytes or 16 bits) of data
typedef unsigned short WORD;

// a type used to hold two WORDS (4 bytes or 32 bits) of data
...
struct HAPI_TColour
{
	...
	HAPI_TColour(): blue(255),green(255),red(255),alpha(255){}
